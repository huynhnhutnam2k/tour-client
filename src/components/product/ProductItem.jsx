...
const ProductItem = ({ product, isLoading }) => {
    const { value: settingData } = useSelector((store) => store.settingReducer)
        ...
        <div className="w-full">
            <div className="w-full pt-[30px] px-3 lg:px-[12px] relative h-full flex flex-col flex-1 justify-between">
                ...
                <div className="img w-full aspect-square relative overflow-hidden rounded-lg flex-shrink-0">
                    ...
                    ) : <div className="w-full h-full flex flex-shrink-0 justify-center items-center">
                        <Link href={createLinkPost(product)} className="w-full h-full">
                            <ImgCustom
                                src={product?.image || settingData?.data?.logo_dark}
                                width={400}
                                height={400}
                                alt="logo"
                                fit="cover"
